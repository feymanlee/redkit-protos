...
const (
	AuthenticationService_Login_FullMethodName        = "/gamoji.auth.v1.AuthenticationService/Login"
	AuthenticationService_RefreshToken_FullMethodName = "/gamoji.auth.v1.AuthenticationService/RefreshToken"
	AuthenticationService_Logout_FullMethodName       = "/gamoji.auth.v1.AuthenticationService/Logout"
)
...
func (c *authenticationServiceClient) RefreshToken(ctx context.Context, in *RefreshTokenRequest, opts ...grpc.CallOption) (*TokenPair, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenPair)
...
func (UnimplementedAuthenticationServiceServer) RefreshToken(context.Context, *RefreshTokenRequest) (*TokenPair, error) {
...
var AuthenticationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gamoji.auth.v1.AuthenticationService",
	...
	Metadata: "gamoji/auth/v1/auth.proto",
}
