...
// 	protoc        (unknown)
// source: core/authentication/v1/authentication_error.proto
...
func (AuthenticationErrorReason) Descriptor() protoreflect.EnumDescriptor {
	return file_core_authentication_v1_authentication_error_proto_enumTypes[0].Descriptor()
}

func (AuthenticationErrorReason) Type() protoreflect.EnumType {
	return &file_core_authentication_v1_authentication_error_proto_enumTypes[0]
}
...
func (AuthenticationErrorReason) EnumDescriptor() ([]byte, []int) {
	return file_core_authentication_v1_authentication_error_proto_rawDescGZIP(), []int{0}
}

var File_core_authentication_v1_authentication_error_proto protoreflect.FileDescriptor

const file_core_authentication_v1_authentication_error_proto_rawDesc = "" +
	"\n" +
	"1core/authentication/v1/authentication_error.proto\x12\x16core.authentication.v1\x1a\x13errors/errors.proto*\x96\r\n" +
	...
	"\x1acom.core.authentication.v1B\x18AuthenticationErrorProtoP\x01ZQgithub.com/feymanlee/redkit-protos/gen/go/core/authentication/v1;authenticationpb\xa2\x02\x03CAX\xaa\x02\x16Core.Authentication.V1\xca\x02\x16Core\\Authentication\\V1\xe2\x02\"Core\\Authentication\\V1\\GPBMetadata\xea\x02\x18Core::Authentication::V1b\x06proto3"

var (
	file_core_authentication_v1_authentication_error_proto_rawDescOnce sync.Once
	file_core_authentication_v1_authentication_error_proto_rawDescData []byte
)

func file_core_authentication_v1_authentication_error_proto_rawDescGZIP() []byte {
	file_core_authentication_v1_authentication_error_proto_rawDescOnce.Do(func() {
		file_core_authentication_v1_authentication_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_core_authentication_v1_authentication_error_proto_rawDesc), len(file_core_authentication_v1_authentication_error_proto_rawDesc)))
	})
	return file_core_authentication_v1_authentication_error_proto_rawDescData
}

var file_core_authentication_v1_authentication_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_core_authentication_v1_authentication_error_proto_goTypes = []any{
	(AuthenticationErrorReason)(0), // 0: core.authentication.v1.AuthenticationErrorReason
}
var file_core_authentication_v1_authentication_error_proto_depIdxs = []int32{
...
func init() { file_core_authentication_v1_authentication_error_proto_init() }
func file_core_authentication_v1_authentication_error_proto_init() {
	if File_core_authentication_v1_authentication_error_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_core_authentication_v1_authentication_error_proto_rawDesc), len(file_core_authentication_v1_authentication_error_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_core_authentication_v1_authentication_error_proto_goTypes,
		DependencyIndexes: file_core_authentication_v1_authentication_error_proto_depIdxs,
		EnumInfos:         file_core_authentication_v1_authentication_error_proto_enumTypes,
	}.Build()
	File_core_authentication_v1_authentication_error_proto = out.File
	file_core_authentication_v1_authentication_error_proto_goTypes = nil
	file_core_authentication_v1_authentication_error_proto_depIdxs = nil
}
