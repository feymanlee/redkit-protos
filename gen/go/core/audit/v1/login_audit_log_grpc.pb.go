...
const (
	LoginAuditLogService_List_FullMethodName   = "/core.audit.v1.LoginAuditLogService/List"
	LoginAuditLogService_Get_FullMethodName    = "/core.audit.v1.LoginAuditLogService/Get"
	LoginAuditLogService_Create_FullMethodName = "/core.audit.v1.LoginAuditLogService/Create"
)
...
func RegisterLoginAuditLogServiceServer(s grpc.ServiceRegistrar, srv LoginAuditLogServiceServer) {
	// If the following call pancis, it indicates UnimplementedLoginAuditLogServiceServer was
...
var LoginAuditLogService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "core.audit.v1.LoginAuditLogService",
	...
	Metadata: "core/audit/v1/login_audit_log.proto",
}
