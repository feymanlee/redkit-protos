...
const OperationLoginPolicyServiceCreate = "/admin.core.v1.LoginPolicyService/Create"
const OperationLoginPolicyServiceDelete = "/admin.core.v1.LoginPolicyService/Delete"
const OperationLoginPolicyServiceGet = "/admin.core.v1.LoginPolicyService/Get"
const OperationLoginPolicyServiceList = "/admin.core.v1.LoginPolicyService/List"
const OperationLoginPolicyServiceUpdate = "/admin.core.v1.LoginPolicyService/Update"
...
func RegisterLoginPolicyServiceHTTPServer(s *http.Server, srv LoginPolicyServiceHTTPServer) {
	...
	r.POST("/admin/v1/login-policies", _LoginPolicyService_Create1_HTTP_Handler(srv))
	r.PUT("/admin/v1/login-policies/{id}", _LoginPolicyService_Update1_HTTP_Handler(srv))
	r.DELETE("/admin/v1/login-policies/{id}", _LoginPolicyService_Delete1_HTTP_Handler(srv))
}
...
func _LoginPolicyService_Create1_HTTP_Handler(srv LoginPolicyServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _LoginPolicyService_Update1_HTTP_Handler(srv LoginPolicyServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _LoginPolicyService_Delete1_HTTP_Handler(srv LoginPolicyServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
