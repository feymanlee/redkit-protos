...
const OperationMenuServiceCreate = "/admin.core.v1.MenuService/Create"
const OperationMenuServiceDelete = "/admin.core.v1.MenuService/Delete"
const OperationMenuServiceGet = "/admin.core.v1.MenuService/Get"
const OperationMenuServiceList = "/admin.core.v1.MenuService/List"
const OperationMenuServiceUpdate = "/admin.core.v1.MenuService/Update"
...
func RegisterMenuServiceHTTPServer(s *http.Server, srv MenuServiceHTTPServer) {
	...
	r.POST("/admin/v1/menus", _MenuService_Create2_HTTP_Handler(srv))
	r.PUT("/admin/v1/menus/{id}", _MenuService_Update2_HTTP_Handler(srv))
	r.DELETE("/admin/v1/menus/{id}", _MenuService_Delete2_HTTP_Handler(srv))
}
...
func _MenuService_Create2_HTTP_Handler(srv MenuServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _MenuService_Update2_HTTP_Handler(srv MenuServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _MenuService_Delete2_HTTP_Handler(srv MenuServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
