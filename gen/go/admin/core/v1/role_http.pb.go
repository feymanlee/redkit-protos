...
const OperationRoleServiceCreate = "/admin.core.v1.RoleService/Create"
const OperationRoleServiceDelete = "/admin.core.v1.RoleService/Delete"
const OperationRoleServiceGet = "/admin.core.v1.RoleService/Get"
const OperationRoleServiceList = "/admin.core.v1.RoleService/List"
const OperationRoleServiceUpdate = "/admin.core.v1.RoleService/Update"
...
func RegisterRoleServiceHTTPServer(s *http.Server, srv RoleServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/roles", _RoleService_List12_HTTP_Handler(srv))
	r.GET("/admin/v1/roles/{id}", _RoleService_Get13_HTTP_Handler(srv))
	r.POST("/admin/v1/roles", _RoleService_Create6_HTTP_Handler(srv))
	r.PUT("/admin/v1/roles/{id}", _RoleService_Update6_HTTP_Handler(srv))
	r.DELETE("/admin/v1/roles/{id}", _RoleService_Delete7_HTTP_Handler(srv))
}

func _RoleService_List12_HTTP_Handler(srv RoleServiceHTTPServer) func(ctx http.Context) error {
...
func _RoleService_Create6_HTTP_Handler(srv RoleServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _RoleService_Update6_HTTP_Handler(srv RoleServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _RoleService_Delete7_HTTP_Handler(srv RoleServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
